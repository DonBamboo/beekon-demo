-- Fix the get_competitor_time_series function to include competitor_id and competitor_name
...
COMMENT ON FUNCTION beekon_data.get_competitor_time_series IS 'Fixed to include competitor_id and competitor_name fields required by the Share of Voice Over Time chart. This resolves the issue where the frontend could not display time-series data due to missing competitor_id field.';